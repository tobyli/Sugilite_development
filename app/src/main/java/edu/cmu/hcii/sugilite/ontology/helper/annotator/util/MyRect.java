package edu.cmu.hcii.sugilite.ontology.helper.annotator.util;
...
public final class MyRect {
     ...
     */
    public static MyRect unflattenFromString(String str) {
        Matcher matcher = UnflattenHelper.getMatcher(str);
        if (!matcher.matches()) {
            return null;
        }
        return new MyRect(Integer.parseInt(matcher.group(1)),
     ...
     */
    public void inset(MyRect insets) {
        left += insets.left;
        top += insets.top;
        right -= insets.right;
     ...
     *              return false and do not change this rectangle.
     */
    public boolean intersect(MyRect r) {
     ...
     */
    public boolean setIntersect(MyRect a, MyRect b) {
     ...
     */
    public static boolean intersects(MyRect a, MyRect b) {
