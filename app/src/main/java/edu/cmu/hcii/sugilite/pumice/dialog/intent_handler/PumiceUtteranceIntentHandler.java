...
public interface PumiceUtteranceIntentHandler {
    enum PumiceIntent {USER_INIT_INSTRUCTION, TEST_WEATHER, START_OVER, UNDO_STEP, SHOW_KNOWLEDGE, SHOW_RAW_KNOWLEDGE, ADD_CONDITIONAL, ADD_CONDITIONAL_2, ADD_TO_SCRIPT, CHECKING_LOC, RUN_THROUGH, MOVE_STEP}
