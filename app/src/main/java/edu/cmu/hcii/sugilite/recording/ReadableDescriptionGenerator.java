...
public class ReadableDescriptionGenerator {
    ...
    public String generateReadableDescription(SugiliteBlock block){
        ...
        /*else if (block instanceof SugiliteConditionBlock) {
            return setColor("If ", Const.SCRIPT_CONDITIONAL_COLOR) + ((SugiliteConditionBlock) block).getSugiliteBooleanExpression().toString() + "\n" + ((SugiliteConditionBlock) block).getIfBlock().getDescription() + ReadableDescriptionGenerator.setColor("Else ", Const.SCRIPT_CONDITIONAL_COLOR) + ((SugiliteConditionBlock) block).getElseBlock().getDescription();
        }*/
