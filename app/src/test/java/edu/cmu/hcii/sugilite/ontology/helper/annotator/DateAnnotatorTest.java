...
public class DateAnnotatorTest {
    ...
    public void testBasic() {
        List<SugiliteTextAnnotator.AnnotatingResult> res = annotator.annotate("02-08-2018");
    ...
    public void testBasic1() {
        List<SugiliteTextAnnotator.AnnotatingResult> res = annotator.annotate("2/8/2018");
        assertEquals(res.size(), 1);
        Calendar cal = new GregorianCalendar();
        cal.set(2018, 1, 8, 0, 0, 0);
        assertEquals(res.get(0).getNumericValue().longValue()/1000, cal.getTime().getTime()/1000);
    ...
    public void testBasic2() {
        List<SugiliteTextAnnotator.AnnotatingResult> res = annotator.annotate("Feb 8, 2018");
        assertEquals(res.size(), 1);
        Calendar cal = new GregorianCalendar();
        cal.set(2018, 1, 8, 0, 0, 0);
        assertEquals(res.get(0).getNumericValue().longValue()/1000, cal.getTime().getTime()/1000);
    ...
    public void testBasic3() {
        List<SugiliteTextAnnotator.AnnotatingResult> res = annotator.annotate("2018.2.08");
        assertEquals(res.size(), 1);
        Calendar cal = new GregorianCalendar();
        cal.set(2018, 1, 8, 0, 0, 0);
        assertEquals(res.get(0).getNumericValue().longValue()/1000, cal.getTime().getTime()/1000);
    ...
    public void testBadInput() {
        List<SugiliteTextAnnotator.AnnotatingResult> res = annotator.annotate("3/32/2018");
        assertEquals(res.size(), 0);
    }

    @Test
    public void testBadInput1() {
        List<SugiliteTextAnnotator.AnnotatingResult> res = annotator.annotate("8 Feb 2018");
        assertEquals(res.size(), 0);
    }
