...
public class TimeAnnotatorTest {
    ...
    public void testBasicInput1() {
        ...
        assertEquals(results.get(0).getNumericValue().intValue(), (23*60+59)*1000);
    ...
    public void testBasicInput2() {
        ...
        assertTrue(results.size() == 1);
        assertEquals(results.get(0).getNumericValue().intValue(), (13*60+59)*1000);
        assertTrue(results.get(0).getRelation().equals(SugiliteRelation.CONTAINS_TIME));
    }
    ...
    public void testBasicInput3() {
        ...
        assertTrue(results.size() == 1);
        assertEquals(results.get(0).getNumericValue().intValue(), (15*60+0)*1000);
        assertTrue(results.get(0).getRelation().equals(SugiliteRelation.CONTAINS_TIME));
    }
    ...
    public void testMultipleInputs1() {
        ...
        assertEquals(results.get(0).getNumericValue().intValue(), (12*60+0)*1000);
        assertEquals(results.get(1).getNumericValue().intValue(), (13*60+59)*1000);
        assertEquals(results.get(2).getNumericValue().intValue(), (16*60+0)*1000);
    }
    ...
    public void testMultipleInputs2() {
        ...
        assertTrue(results.size() == 3);
        results.sort((a, b) -> Double.compare(a.getNumericValue(), b.getNumericValue()));
        assertEquals(results.get(0).getNumericValue().intValue(), (0*60+0)*1000);
        assertEquals(results.get(1).getNumericValue().intValue(), (15*60+45)*1000);
        assertEquals(results.get(2).getNumericValue().intValue(), (16*60+0)*1000);
    }
}